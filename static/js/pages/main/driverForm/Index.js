...
(global.webpackJsonp = global.webpackJsonp || []).push([ [ "pages/main/driverForm/Index" ], {
    1: function(t, e, o) {
        o.r(e);
        var n = o(2), r = o.n(n);
    ...
    20: function(t, e, o) {
        ...
        p.IS_DELIVERY = "IS_DELIVERY", p.IS_RECEIVED = "IS_RECEIVED", (d = e.LOGIN_TYPE || (e.LOGIN_TYPE = {})).WINXIN_H5 = "WINXIN_H5", 
    ...
    259: function(t, e, o) {
        (function(t) {
            ...
            var i = n(o(19)), a = Object.assign || function(t) {
                ...
                return t;
            }, s = o(23), u = n(o(103)), c = n(o(27)), p = n(o(49)), d = o(65);
            e.default = {
                name: "DriverForm",
                components: {
                    toast: c.default
                ...
                data: function() {
                    return {
                        disabled: !0,
                        idTypes: [ "居民身份证", "军官证", "士兵证", "军官退休", "境外人员", "外交人员", "护照号" ],
                        showSelectIDType: !1,
                        selectedIDValue: "",
                        showSelectArea: !1,
                        form: {
                        ...
                        photo: this.$utils.cache.getTempCache("tempPhoto")
                    };
                },
                computed: a({
                    themeClass: function() {
                    ...
                    cityName: function(t) {
                        return t.common.city.name;
                    }
                }), {
                    cardType: function() {
                        return 1 === this.form.idType ? "idcard" : "text";
                    }
                }),
                watch: {
                    form: {
                        handler: function() {
                            var t = this;
                            this.disabled = Object.keys(this.form).some(function(e) {
                                return "" === t.form[e];
                            });
                        },
                        deep: !0
                    ...
                    return r(i.default.mark(function e() {
                        ...
                        return i.default.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                              case 0:
                                return (o = t.$utils.cache.getLocalCache("driverForm")) && (t.form = o, t.selectedIDValue = t.idTypes[o.idType - 1]), 
                                t.$buriedPoint.recordLog({
                                    operateCode: "drivinglicense_load"
                                }), e.next = 5, t.getCertificationInfo();
                ...
                methods: {
                    getCertificationInfo: function() {
                        ...
                        return r(i.default.mark(function e() {
                            ...
                            return i.default.wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                  case 0:
                                    if (t.certificationInfo = t.$utils.cache.getTempCache("certificationInfo") || {}, 
                                    "{}" === JSON.stringify(t.certificationInfo)) return e.prev = 2, t.$toast.loading({
                                        selector: "#toast",
                                        duration: 0,
                                        forbidClick: !0,
                                        message: "加载中……"
                                    }), e.next = 6, t.$apis.commonApis.getCertificationInfo({
                                  ...
                                  case 6:
                                    o = e.sent, n = o.data, t.certificationInfo = n;

                                  case 9:
                                    return e.prev = 9, t.$toast.clear(), e.finish(9);
                    ...
                    onConfirm: function(t) {
                        var e = t.detail, o = e.value, n = e.index;
                        this.showSelectIDType = !1, this.form.idType = n + 1, this.selectedIDValue = o;
                    },
                    onCancel: function() {
                        this.showSelectIDType = !1;
                    },
                    submit: function(e) {
                        var o, n = this;
                        new u.default({
                            name: [ {
                                ...
                                validator: function(t, e, o) {
                                    /^[a-zA-Z\u4e00-\u9fa5]{1,10}$/.test(e) ? o() : o("请输入正确的申请人姓名");
                                }
                            } ],
                            idType: {
                                required: !0,
                            ...
                            idNumber: [ {
                                ...
                                validator: function(t, e, o) {
                                    1 !== n.form.idType || /(^\d{15}$)|(^\d{18}$)|(^\d{17}(\d|X|x)$)/.test(e) ? o() : o("请输入正确的身份证号码");
                                }
                            } ]
                        }).validate(this.form, (o = r(i.default.mark(function o(r) {
                            var s, u, c;
                            return i.default.wrap(function(o) {
                                for (;;) switch (o.prev = o.next) {
                                  case 0:
                                    if (r) return n.$toast.fail({
                                        message: r[0].message,
                                        selector: "#toast"
                                    }), o.abrupt("return");
                                    o.next = 3;
                                  ...
                                  case 3:
                                    n.$buriedPoint.recordLog({
                                        operateCode: "drivinglicense_next"
                                    }), n.$toast.loading({
                                        duration: 0,
                                        message: "上传中……",
                                        selector: "#toast",
                                    ...
                                    try {
                                        n.$route.query.photoOrderId && (s = e.detail.formId, n.$apis.weChatApis.saveFormId({
                                            formId: s,
                                            type: "FORM_ID",
                                            source: "WEIXIN_APP"
                                        }));
                                    } catch (o) {}
                                    return o.prev = 6, n.disabled = !0, o.next = 10, t.uploadFile({
                                        ...
                                        formData: a({
                                            photoType: 1,
                                            districtCode: n.certificationInfo.districtCode || n.$store.state.common.city.districtCode,
                                            certificateCode: n.certificationInfo.certificateCode,
                                            certificationInfoId: n.$route.query.certificationInfoId,
                                            photoOrderId: n.$route.query.photoOrderId || "",
                                            photoInfoId: n.$route.query.photoInfoId || ""
                                        }, n.form, {
                                            customWidth: n.$route.query.customWidth || "",
                                            customHeight: n.$route.query.customHeight || ""
                                        })
                                    });

                                  case 10:
                                    if (200 === (u = o.sent).statusCode) return c = JSON.parse(u.data), o.next = 15, 
                                    (0, d.responseIntercetor)(c);
                                    o.next = 22;
                                    break;

                                  case 15:
                                    n.certificationInfo.enableUpOrgPic && n.uploadOriginalImage(c.data.photoInfoId), 
                                    n.$buriedPoint.recordLog({
                                        operateCode: "enter_server",
                                        photoInfoId: c.data.photoInfoId
                                    }), n.$utils.cache.setLocalCache("driverForm", n.form, 1 / 0), n.$router.replace({
                                  ...
                                  case 25:
                                    o.prev = 25, o.t0 = o.catch(6), n.$toast({
                                        message: "网络错误请稍后重试",
                                        selector: "#toast",
                                        position: "bottom"
                                    });
                                  ...
                                  case 28:
                                    return o.prev = 28, n.disabled = !1, o.finish(28);
    ...
    327: function(t, e, o) {
        ...
        var n = function() {
            ...
            return o("div", {
            ...
            }, [ t._ri(!!this.$store.state.common.theme, 3) ? o("image", {
                attrs: {
                    h_: 3
                }
            }) : o("image", {
                ...
                directives: [ {
                    name: "model",
                    rawName: "v-model",
                    value: t.certificationInfo.cityName,
                    expression: "certificationInfo.cityName"
                } ],
                attrs: {
                    h_: 17
                },
                ...
                on: {
                    input: function(e) {
                        e.target.composing || t.$set(t.certificationInfo, "cityName", e.target.value);
                    }
                }
            }) ]), o("li", {
                attrs: {
                ...
                directives: [ {
                    name: "model",
                    rawName: "v-model",
                    value: t.selectedIDValue,
                    expression: "selectedIDValue"
                } ],
                attrs: {
                    h_: 29
                },
                ...
                on: {
                    input: function(e) {
                        e.target.composing || (t.selectedIDValue = e.target.value);
                    }
                }
            }), o("image", {
                attrs: {
                ...
                on: {
                    input: function(e) {
                        e.target.composing || t.$set(t.form, "idNumber", e.target.value);
                    }
                }
            }) ]) ]), o("van-popup", {
                attrs: {
                    show: t.showSelectIDType,
                    h_: 39
                },
                on: {
                    close: t.onCancel
    ...
    37: function(t, e, o) {
        ...
        var n = o(14), r = n.__importDefault(o(65)), i = n.__importDefault(o(95)), a = n.__importDefault(o(96)), s = n.__importDefault(o(97)), u = n.__importDefault(o(98)), c = n.__importDefault(o(99)), p = n.__importDefault(o(100)), d = n.__importDefault(o(101)), l = n.__importDefault(o(102)), f = n.__importDefault(o(74)), h = n.__importDefault(o(80)), m = new (e.APIs = function() {
            ...
            this.orderApis = new d.default(r.default), this.weChatApis = new l.default(r.default), 
            this.weAppApis = new f.default(r.default), this.couponApis = new h.default(r.default);
        })();
        e.default = m;
    },
    38: function(t, e, o) {
    ...
    580: function(t, e, o) {
        ...
        o(581);
        var a = o(0), s = Object(a.a)(r.default, n.a, n.b, !1, null, null, null);
        s.options.__file = "src/pages/main/driverForm/Index.vue", e.default = s.exports;
    },
    581: function(t, e, o) {
        var n = o(260);
        o.n(n).a;
    ...
    65: function(e, o, n) {
        (function(e) {
            ...
            var s = n(14), u = s.__importDefault(n(87)), c = s.__importDefault(n(88)), p = s.__importDefault(n(89)), d = s.__importDefault(n(38)), l = s.__importDefault(n(49)), f = s.__importDefault(n(73)), h = s.__importDefault(n(28)), m = s.__importDefault(n(83)), g = s.__importDefault(n(91)), _ = s.__importDefault(n(67)), y = new c.default(p.default(f.default));
            y.config = l.default, y.interceptors.request.use(function(e) {
                return s.__awaiter(void 0, void 0, void 0, function() {
                    return s.__generator(this, function(o) {
                        return l.default.headers.appid = d.default.state.common.mid || "", l.default.headers.thirdAppId = d.default.state.common.weChatAppID || "", 
                        l.default.headers.token = d.default.state.auth.token, l.default.headers.userId = d.default.state.auth.userId, 
    ...
    84: function(t, e, o) {
        (function(t) {
            ...
            var r = o(14), i = r.__importDefault(o(37)), a = r.__importDefault(o(66)), s = r.__importDefault(o(28)), u = r.__importDefault(o(38)), c = o(161), p = o(68), d = o(162), l = (n.prototype.recordLog = function(t) {
                var e;
                return r.__awaiter(this, void 0, void 0, function() {
                    var o, n, i, c, l, f, h, m, g;
                    return r.__generator(this, function(r) {
                        switch (r.label) {
                          case 0:
                          ...
                          case 2:
                            return l = r.sent(), f = l.system.split(" "), h = f[0], m = f[1], g = {
                                nanoid: d(8),
    ...
    91: function(t, e, o) {
        ...
        var r = o(14), i = r.__importDefault(o(73)), a = r.__importDefault(o(88)), s = r.__importDefault(o(89)), u = r.__importDefault(o(74)), c = r.__importDefault(o(37)), p = r.__importDefault(o(49)), d = r.__importDefault(o(38)), l = r.__importStar(o(65)), f = (n.prototype.login = function(t, e) {
            ...
            return r.__awaiter(this, void 0, void 0, function() {
                ...
                return r.__generator(this, function(o) {
                    switch (o.label) {
                      ...
                      case 1:
                        return e = o.sent().data, d.default.commit("auth/login", e), l.default.unlock(), 
